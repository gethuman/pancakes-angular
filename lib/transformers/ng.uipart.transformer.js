...
function getCtrlTemplateModel(uipart, names, options) {
    ...
    var scopeWatchers = uipart.scopeWatchers ? JSON.stringify(uipart.scopeWatchers): 'null';
    var eventWatchers = uipart.eventWatchers ? JSON.stringify(uipart.eventWatchers): 'null';
    ...
    return {
        ...
        computeModelFn:     this.transformers.basic.transform(uipart.model, transOpts),
        useScopeRerender:   names.isPartial && uipart.model && uipart.scopeWatchers && uipart.scopeWatchers.length,
        useEventRerender:   names.isPartial && uipart.model && uipart.eventWatchers && uipart.eventWatchers.length,
