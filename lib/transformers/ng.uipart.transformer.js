...
function getCtrlTemplateModel(uipart, options) {
    ...
    var remodelWatchers = uipart.remodelOnScopeChange ? JSON.stringify(uipart.remodelOnScopeChange): 'null';
    var remodelEvents = uipart.remodelOnEvent ? JSON.stringify(uipart.remodelOnEvent): 'null';
    ...
    var useRemodelOnWatch = uipart.model && uipart.remodelOnScopeChange && uipart.remodelOnScopeChange.length;
    var useRemodelOnEvent = uipart.model && uipart.remodelOnEvent && uipart.remodelOnEvent.length;
    ...
    return {
        ...
        remodelExists:      uipart.model,
        remodelFn:          this.transformers.basic.transform(uipart.model, transOpts),
