 ...
 * @constructor
 */
function RoutingTransformer() {
    pancakes.BaseTransformer.call(this, pancakes, __dirname, 'ng.routing');
}

_.extend(RoutingTransformer.prototype, pancakes.BaseTransformer.prototype, {
...
module.exports =  new RoutingTransformer();