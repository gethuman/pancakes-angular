...
function registerMobileComponents() {
    jangular.registerComponents([
        'ionActionSheet', 'ionCheckbox', 'ionContent',
        'ionHeaderBar', 'ionFooterBar', 'ionInfiniteScroll', 'ionItem', 'ionDeleteButton',
        'ionOptionButton', 'ionReorderButton',
        'ionList', 'ionModal', 'ionModalView', 'ionNavBackButton',
        'ionNavBar', 'ionNavButtons', 'ionNavTitle',
        'ionNavView', 'ionPane', 'ionPopover', 'ionPopoverView', 'ionRadio',
        'ionRefresher', 'ionScroll', 'ionSideMenu', 'ionSideMenuContent', 'ionSideMenus',
        'ionSlideBox', 'ionSpinner', 'ionTabs', 'ionToggle', 'ionView'
    ]);
}
