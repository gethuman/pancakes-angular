...
function renderLayout(appName, layoutName, dependencies) {
    ...
    return this.jangular.templateToString(this.jangular.naked(layout), dependencies.model);
}
...
function renderPage(routeInfo, page, model) {
    ...
    this.setDefaults(model, page.defaults);
    ...
    // render the view
    var renderedPage = this.jangular.templateToString(view, model, routeInfo.strip);
